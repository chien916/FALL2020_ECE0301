...
private://beginning with the member variables for
	...
	bool f_ifNegative(Signal, std::string& out);
public:
	...
	void f_fill_sgn_sinusoid(double A, double f0, double ph);// fills the signal vector with values for a sinusoidal signal.
};
