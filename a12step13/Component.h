...
public:
	...
	void Component_f_config(int type);//custom function to set up Component_s_config[4]
	void Component_f_config();//custom function to set up Component_s_config[4]
	int Component_f_get_config(int ind);//custom function to get Component_s_config[4]
};
#endif